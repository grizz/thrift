...
class t_cpp_generator : public t_oop_generator {
 public:
  ...
  void generate_struct_definition    (std::ofstream& out, t_struct* tstruct, bool is_exception=false, bool pointers=false, bool read=true, bool write=true, bool typedefs = false);
...
void t_cpp_generator::generate_async_client(t_service* tservice) {
  ...
  indent(f_header_) << "bool process(boost::shared_ptr<apache::thrift::protocol::TProtocol> piprot, boost::shared_ptr<apache::thrift::protocol::TProtocol> poprot);" << endl;
  ...
  indent(f_service_) << "bool " << scope << "process(boost::shared_ptr<apache::thrift::protocol::TProtocol> piprot, boost::shared_ptr<apache::thrift::protocol::TProtocol> poprot)" << endl;
  scope_up(f_service_);
	f_service_ <<
		indent() << "std::string fname;" << endl <<
		indent() << "apache::thrift::protocol::TMessageType mtype;" << endl <<
...
void t_cpp_generator::generate_async_processor(t_service* tservice) {
  ...
  // Generate the server implementation
  f_service_ <<
    "bool " << service_name_ << "AsyncProcessor::process(boost::shared_ptr<apache::thrift::protocol::TProtocol> piprot, boost::shared_ptr<apache::thrift::protocol::TProtocol> poprot) {" << endl;
  indent_up();
...
void t_cpp_generator::generate_function_helpers(t_service* tservice,
  ...
  generate_struct_definition(f_header_, &result, false, false, true, true, true);
